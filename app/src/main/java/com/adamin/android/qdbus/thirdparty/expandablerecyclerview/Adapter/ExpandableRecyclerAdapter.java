package com.adamin.android.qdbus.thirdparty.expandablerecyclerview.Adapter;
...
import com.adamin.android.qdbus.thirdparty.expandablerecyclerview.Model.ParentWrapper;
...
public abstract class ExpandableRecyclerAdapter<PVH extends ParentViewHolder, CVH extends ChildViewHolder>
     ...
     * <br><br/>
     * 注册监听 展开和收回。在接收回调的Activity 或Fragment实现这个接口
     */
    public interface ExpandCollapseListener {

        /**
         * Called when a list item is expanded.<br><br/>
         * item展开时被调用
         *
         * @param position The index of the item in the list being expanded
         * @param position 展开item的index
         */
        void onListItemExpanded(int position);

        /**
         * Called when a list item is collapsed.<br><br/>
         * item收回时调用
         *
         * @param position The index of the item in the list being collapsed
         *                 <br><br/>
         * @param position 收回item的position
         */
     ...
     * <br><br/>
     * 基本的构造器。组装{@link #mParentItemList}和 {@link #mItemList}.
     *<br><br/>
     * Changes to {@link #mParentItemList} should be made through add/remove methods in
     * {@link ExpandableRecyclerAdapter}
     * <br><br/>
     * {@link #mParentItemList}的变化应该由{@link ExpandableRecyclerAdapter}的add/remove方法实现
     *
